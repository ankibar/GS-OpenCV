#this code detects movement of the person
...
while True:
	...
	#purpose of grayscaling and blurring is for a clearer diffrentiation of the moving person 
	...
	# first frame
	#frameDelta takes care of the difference between the moving person and background by seeing 
